...
import bg.tu_varna.sit.models.Location;
...
public class Add implements bg.tu_varna.sit.interfaces.Add {
    private final ManageHistory addProduct;
    private final Warehouse warehouse;
    private final Scanner scanner = new Scanner(System.in);

    public Add(ManageHistory addProduct, Warehouse warehouse) {
    ...
    public boolean checkDateEquality(String expiryDateNew, String expiryDateCurr) {
        ...
        return expiryDateNew.equals(expiryDateCurr);
    }
    ...
    public void warehouseFunction() throws NegativeNumberException, IOException, LocationException {
        ...
        add(warehouse.getProducts(), product);
    }
